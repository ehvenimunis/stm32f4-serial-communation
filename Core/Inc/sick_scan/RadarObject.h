#ifndef _ROS_sick_scan_RadarObject_h
#define _ROS_sick_scan_RadarObject_h
...
namespace sick_scan
{
  ...
  class RadarObject : public ros::Msg
  {
    public:
    ...
    RadarObject():
      ...
      object_box_center(),
      object_box_size(),
      contour_points_length(0), st_contour_points(), contour_points(nullptr)
    {
    }
    ...
    virtual const char * getType() override { return "sick_scan/RadarObject"; };
    virtual const char * getMD5() override { return "a5d0f2d250163ffa0098d0fc8218fc4a"; };
